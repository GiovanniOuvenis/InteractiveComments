...
const Comment = (props) => {
  ...
  const [replyTo, setReplyTo] = useState("postReply");
  ...
  useEffect(() => {
    if (props.typeOfComment === "reply") {
      contentRef.current.classList.add("indented");
      wrapperRef.current.classList.add("replyComment");
      setReplyTo("replyToReply");
    }
    if (props.order === 0 && props.comment.replies.length === 0) {
      wrapperRef.current.classList.add("lastComment");
    }
  });
      ...
      <div className="wrapper" ref={wrapperRef}>
        <div className="comment-container" ref={containerRef}>
          ...
          <div className="iconsAndText">
            ...
            <p className="commentText" ref={contentRef}>
              {content}
            </p>
          </div>
        </div>
